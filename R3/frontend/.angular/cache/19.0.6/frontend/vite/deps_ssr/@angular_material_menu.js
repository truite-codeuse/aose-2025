...
var MatMenuTrigger = class _MatMenuTrigger {
  ...
  _destroyMenu(reason) {
    ...
    if (menu instanceof MatMenu && this._ownsMenu(menu)) {
      this._pendingRemoval = menu._animationDone.pipe((0, import_operators2.take)(1)).subscribe(() => overlayRef.detach());
