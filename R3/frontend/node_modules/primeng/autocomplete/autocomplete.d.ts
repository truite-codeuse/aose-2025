...
import { AfterContentInit, AfterViewChecked, ElementRef, EventEmitter, NgZone, OnDestroy, QueryList, TemplateRef } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { OverlayOptions, OverlayService, PrimeTemplate, ScrollerOptions } from 'primeng/api';
 ...
 * @group Components
 */
export declare class AutoComplete extends BaseComponent implements AfterViewChecked, AfterContentInit, OnDestroy, ControlValueAccessor {
    ...
    get panelClass(): {
        'p-autocomplete-overlay p-component': boolean;
        'p-input-filled': boolean;
        'p-ripple-disabled': boolean;
    };
    get inputClass(): {
        'p-autocomplete-input': boolean;
    ...
    optionClass(option: any, i: any, scrollerOptions: any): {
...
export declare class AutoCompleteModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<AutoCompleteModule, never, [typeof AutoComplete], [typeof AutoComplete, typeof i1.SharedModule]>;
