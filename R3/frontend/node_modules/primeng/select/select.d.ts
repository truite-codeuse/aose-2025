...
import { FilterService, OverlayOptions, PrimeTemplate, ScrollerOptions } from 'primeng/api';
...
export declare class SelectItem extends BaseComponent {
    id: string | undefined;
    option: any;
 ...
 * @group Components
 */
export declare class Select extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    zone: NgZone;
