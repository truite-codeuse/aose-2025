...
import { AfterContentInit, DoCheck, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, PipeTransform, QueryList, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class PasswordDirective extends BaseComponent implements OnDestroy, DoCheck {
    zone: NgZone;
    /**
    ...
    onFocus(): void;
    onBlur(): void;
    labelSignal: import("@angular/core").WritableSignal<string>;
 ...
 * @group Components
 */
export declare class Password extends BaseComponent implements OnInit, AfterContentInit {
    /**
